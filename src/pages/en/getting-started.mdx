...
<div class="block-wrapper" style="display:flex;
  ...
  <rux-card class="block">
    <div slot="header"><h4>Brand Strategy</h4></div>
  ...
  <rux-card class="block">
    <div slot="header"><h4>Content Strategy</h4></div>
    Suscipit potenti habitant penatibus praesent quam class erat purus nisl ligula arcu accumsan risus, interdum phasellus lorem leo libero maecenas dictumst donec dis cras ante finibus.
  </rux-card>
  <rux-card class="block">
    <div slot="header"><h4>Digital Media</h4></div>
    Suscipit potenti habitant penatibus praesent quam class erat purus nisl ligula arcu accumsan risus, interdum phasellus lorem leo libero maecenas dictumst donec dis cras ante finibus.
  </rux-card>
  <rux-card class="block">
    <div slot="header"><h4>Omnichannel Creative</h4></div>
    Suscipit potenti habitant penatibus praesent quam class erat purus nisl ligula arcu accumsan risus, interdum phasellus lorem leo libero maecenas dictumst donec dis cras ante finibus.
  </rux-card>
  <rux-card class="block">
    <div slot="header"><h4>Web Development</h4></div>
    Suscipit potenti habitant penatibus praesent quam class erat purus nisl ligula arcu accumsan risus, interdum phasellus lorem leo libero maecenas dictumst donec dis cras ante finibus.
  </rux-card>
  <rux-card class="block">
    <div slot="header"><h4>Insights + Analytics</h4></div>
    Suscipit potenti habitant penatibus praesent quam class erat purus nisl ligula arcu accumsan risus, interdum phasellus lorem leo libero maecenas dictumst donec dis cras ante finibus.
  </rux-card>
